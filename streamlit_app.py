...
st.set_page_config(
   ...
   menu_items={
       ...
       'About': "Bu uygulama, şu özellikleri içermektedir..."
   }
)

# image_path = "C:/Users/batuy/OneDrive/Desktop/banka.webp"

st.image("C:/Users/batuy/OneDrive/Desktop/banka.webp",width=350)
...
# abone_durumu	age	default	balance	housing	loan	day	month	duration	campaign	pdays	previous


# Başlık ve veri sözlüğü
...
if st.sidebar.button("Submit"):
    ...
    # Prediction sütununu güncelleme
    ...
    if prediction[0] == 1:
        ...
        st.image("C:/Users/batuy/OneDrive/Desktop/carpi.webp",width=750)
else:
